...
sudo DEBIAN_FRONTEND=noninteractive apt-get --yes --force-yes  purge tomcat6 tomcat7 junit4 junit
sudo DEBIAN_FRONTEND=noninteractive apt-get --yes --force-yes  build-dep tomcat7 ant
